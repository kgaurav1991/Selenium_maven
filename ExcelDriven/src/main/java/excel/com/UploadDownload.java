...
public class UploadDownload {
	...
	private static int getColumnNumber(String fileName, String colName) throws IOException { // TODO Auto-generated
																								...
																								// coloum by scanning
																								// the entire 1st row
		Iterator<Row> rows = sheet.iterator();// sheet is collection of rows Row firstrow= rows.next(); Iterator<Cell>
												// ce=firstrow.cellIterator();//row is collection of cells int k=1; int
												// coloumn = 0; while(ce.hasNext()) { Cell value=ce.next();
